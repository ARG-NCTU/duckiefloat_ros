...
class GoalNav(object):
    def __init__(self):
        ...
        model = rospy.get_param("~model", "s0214_f435052.pth") # 0214_f435052, s1536_f1869509
        # s1621_f223365_test s1628_f518639 s1624_f640670_test parabola 
